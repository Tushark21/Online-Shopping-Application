...
public class NewJFrame extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(t10, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
                    .addComponent(t0))
                .addGap(59, 59, 59))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pid="",name="",type="",col="",item="",discription="",brand="",salername="";
        int price=0,discount=0,delivery=0;
        ...
        col=t5.getText();
        item=t3.getText();
        discription=t10.getText();
        brand=t4.getText();
        salername=t9.getText();;
        
        price=Integer.parseInt(t6.getText());
        discount=Integer.parseInt(t7.getText());
        delivery=Integer.parseInt(t8.getText());;
        
        try {
                Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/buykart", "root", "jarvisk21");
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery("Select * from products");
                                                                                                                               
                    String strSQL = "INSERT INTO products (pid,name,type,item,brand,color,price,discount,delivery,salername,discription) VALUES('"+ pid + "','" + name +"','" + type + "','" + item +"','" + brand +"','" + col + "'," + price + "," + discount + "," + delivery + "," + salername + ",'" + discription + "');";
